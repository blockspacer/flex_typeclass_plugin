...
class TestPackageConan(ConanFile):
    ...
    def test(self):
        if not tools.cross_building(self.settings):
            ...
            #
            flex_typeclass_plugin_ROOT = self.deps_cpp_info["flex_typeclass_plugin"].rootpath
            flex_typeclass_plugin_file = flex_typeclass_plugin_ROOT
            flex_typeclass_plugin_file = os.path.join(flex_typeclass_plugin_file, "lib")
            flex_typeclass_plugin_file = os.path.join(flex_typeclass_plugin_file, "flex_typeclass_plugin" + ext)
            self.output.info('flex_typeclass_plugin_file = %s' % (flex_typeclass_plugin_file))
            #
            ...
            flextool_cmd = "flextool" \
              ...
              " --extra-arg=-I{}" \
              " {}/main.cpp".format(
              flex_reflect_plugin_file, flex_typeclass_plugin_file, cling_includes, clang_includes, self.source_folder)
