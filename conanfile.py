...
class flex_typeclass_plugin_conan_project(conan_build_helper.CMakePackage):
    name = "flex_typeclass_plugin"
    ...
    description = "flex_typeclass_plugin: C++ compile-time programming (serialization, reflection, code modification, enum to string, better enum, enum to json, extend or parse language, etc.)."
    topics = ('c++')
    ...
    def build(self):
        ...
        if self._is_tests_enabled():
          ...
          cmake.build(args=["--target", "flex_typeclass_plugin_run_all_tests", "--", "-j%s" % cpu_count])
    ...
    def package_info(self):
        #self.cpp_info.libs = ["flex_typeclass_plugin"]
        ...
        self.env_info.flex_typeclass_plugin_ROOT = self.package_folder
        #flex_typeclass_plugin = "flex_typeclass_plugin.dll" if self.settings.os_build == "Windows" else "flex_typeclass_plugin.so"
        #self.env_info.flex_typeclass_plugin_LIB = os.path.normpath(os.path.join(self.package_folder, "lib", flex_typeclass_plugin))

        #self.cpp_info.includedirs.append(os.getcwd())
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "flex_typeclass_plugin"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "flex_typeclass_plugin", "compat"))
